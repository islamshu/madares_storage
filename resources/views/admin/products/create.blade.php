...
<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <ul class="breadcrumb breadcrumb-style ">
                    ...
                    <li class="breadcrumb-item active">اضف منتج جديد</li>
    ...
    <div class="row clearfix">
        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-8">
            <div class="card">
                <div class="header">
                    <h2 style="display: inline">إضافة منتج جديد</h2>
                                    ...
                                    <form class="form-horizontal" method="post" action="{{ route('products.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input required type="number" value="{{ old('price') }}" name="price" id="price" class="form-control"
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <textarea name="description" class="ckeditor" id="ckeditor" cols="30" rows="10">{{  old('description') }}</textarea>
